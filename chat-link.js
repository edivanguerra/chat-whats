...
// Cria uma tag style e insere o CSS dentro dela
...
document.addEventListener("click", function(event) {
    if (event.target.id === "send-it") {
        ...
        document.getElementById("get-number").innerHTML = event.target.querySelector(".my-number").textContent;
        ...
        document.getElementById("get-nama").innerHTML = event.target.querySelector(".info-chat .chat-nama").textContent;
        document.getElementById("get-label").innerHTML = event.target.querySelector(".info-chat .chat-label").textContent;
